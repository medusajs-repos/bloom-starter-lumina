          ...
          <div className="space-y-8">
            ...
            <div className="bg-white border border-neutral-200 p-8">
              ...
              <div className="space-y-4 text-neutral-700 leading-relaxed">
                ...
                <p>
                  Log into your account and navigate to your order history. Select the order containing the item(s) you wish to return and click "Start Return." Alternatively, you can contact our customer service team at hello@luminaskin.com.
                </p>
            ...
            <div className="bg-white border border-neutral-200 p-8">
              ...
              <div className="space-y-4 text-neutral-700 leading-relaxed">
                ...
                <p>
                  If you prefer a direct exchange, please contact our customer service team at hello@luminaskin.com and we'll assist you with the process.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white border border-neutral-200 p-8">
              ...
              <div className="space-y-4 text-neutral-700 leading-relaxed">
                <p>
                  Quality is at the heart of everything we create. If you receive an item that's damaged or defective, please contact us within 7 days of delivery at hello@luminaskin.com with photos of the issue.
                </p>
                <p>
            ...
            <div className="bg-white border border-neutral-200 p-8">
              ...
              <div className="space-y-4 text-neutral-700 leading-relaxed">
                <p>
                  If you received an incorrect item, we sincerely apologize. Please contact us immediately at hello@luminaskin.com with your order number and a photo of the item received.
                </p>
                <p>
