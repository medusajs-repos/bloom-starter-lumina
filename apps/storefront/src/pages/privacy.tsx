      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 text-neutral-600">
          ...
          <section className="space-y-4">
            ...
            <p>
              At Essentials, we are committed to protecting your privacy and
              ensuring the security of your personal information. This Privacy
              Policy explains how we collect, use, share, and protect your data
              when you visit our website or make a purchase from our store.
            </p>
            <p>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-inside list-disc space-y-2 pl-4">
              <li>
                ...
                carriers, email service providers, analytics providers)
              </li>
              <li>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-inside list-disc space-y-2 pl-4">
              <li>
                ...
                functionality (shopping cart, checkout)
              </li>
              <li>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              privacy@luminaskin.com or through our contact form.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="mt-4 space-y-2 rounded-lg bg-neutral-50 p-6">
              <p>
                <strong>Email:</strong> privacy@luminaskin.com
              </p>
              <p>
                <strong>General Inquiries:</strong> hello@luminaskin.com
              </p>
              <p>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              contact us at privacy@luminaskin.com.
            </p>
          </section>
        </div>
      </div>
